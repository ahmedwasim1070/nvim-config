...
map("n", "<C-c>", '"+yy', opts)   -- copy current line to system clipboard
map("n", "<C-v>", '"+p', opts)    -- paste after cursor from system clipboard
map("v", "<C-c>", '"+y', opts)    -- copy selection to system clipboard
map("i", "<C-v>", '<C-r>+', opts)
