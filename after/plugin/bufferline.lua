-- Custom function to close all buffers
local function close_all_buffers()
	...
	-- Open a new empty buffer so nvim doesn't close
	vim.cmd("enew")
end

-- Create the custom command
vim.api.nvim_create_user_command("BufferLineCloseAll", close_all_buffers, {})
